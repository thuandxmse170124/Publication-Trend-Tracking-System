...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // 4. Start Massive Sync if DB has no papers (Disabled to prevent automatic downloading on startup)
        /*
                    ...
                    .ifPresent(source -> {
                        ...
                        CompletableFuture.runAsync(() -> {
                            try {
                                ...
                                syncService.syncFromSource(source.getSourceId(), null, null, com.publication_trend_tracking_system.sever_web_app.enums.SyncTimeRange.ALL, null, null);
        ...
        */
        log.info("Automatic massive sync is disabled on startup.");
