...
public interface TopicRepository extends JpaRepository<Topic, Integer> {
    ...
    @Query(value = "SELECT t.topic_id as topicId, t.topic_name as topicName, t.description as description, COUNT(pt.paper_id) as paperCount "
            ...
            "GROUP BY t.topic_id, t.topic_name, t.description, t.trend_score ", countQuery = "SELECT COUNT(topic_id) FROM topics", nativeQuery = true)
    org.springframework.data.domain.Page<Object[]> findAllTopicsWithPaperCount(
